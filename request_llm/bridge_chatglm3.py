...
import threading
import importlib
from toolbox import update_ui, get_conf, ProxyNetworkActivate, clip_history
...
class GetGLMHandle(Process):
    ...
    def check_dependency(self):
        try:
            ...
            self.info = "缺少ChatGLM的依赖，如果要使用ChatGLM，除了基础的pip依赖以外，您还需要运行`pip install -r request_llm/requirements_chatglm3.txt`安装ChatGLM的依赖。"
            self.success = False
