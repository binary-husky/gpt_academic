...
class LocalDocQA:
    ...
    def get_knowledge_based_conent_test(self, query, vs_path, chunk_conent,
        ...
        related_docs_with_score = similarity_search_with_score_by_vector(self.vector_store, embedding,
...
def construct_vector_store(vs_id, vs_path, files, sentence_size, history, one_conent, one_content_segmentation,
                           text2vec):
    for file in files:
    ...
    vs_path, loaded_files = local_doc_qa.init_knowledge_vector_store(filelist, os.path.join(vs_path, vs_id),
