...
def main():
    ...
    from comm_tools.toolbox import format_io, find_free_port, on_file_uploaded, on_report_generated, get_conf, ArgsGeneralWrapper, DummyWith, load_chat_cookies
    ...
    title_html = f"<h1 align=\"center\">GPT 学术优化 {get_current_version()}</h1>"
    ...
    cancel_handles = []
    with gr.Blocks(title="GPT 学术优化", theme=set_theme, analytics_enabled=False, css=custom_css) as demo:
        gr.HTML(title_html)
